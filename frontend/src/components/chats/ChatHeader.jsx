...
export default function ChatHeader({ onHistoryClick }) {
  ...
  return (
    <div className="flex items-center justify-between border-b border-[#e5e5e8] dark:border-[#26262c] bg-[#f7f7f8] dark:bg-[#0a0a0c] px-6">
...
//           <button
//             onMouseOver={() => setShowProfileMenu((prev) => !prev)}
//             className="flex h-9 w-auto px-1 items-center justify-center rounded-2xl cursor-pointer bg-gradient-to-br from-[#ff7a18] to-[#ff4d00] font-semibold text-white"
//           >
